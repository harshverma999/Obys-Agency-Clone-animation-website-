...
tl.from("#line1-part1",{
    opacity:0,
    onStart: function(){
        let countdown = document.querySelector("#line1-part1 h5");
        var grow=0;
         const intervalId = setInterval(()=>{
            if(grow<100){
                countdown.innerText = grow++;
            }else{
                countdown.innerText = grow;
...
document.querySelector("#page1-line3").addEventListener("mouseenter",function(){
    gsap.to("#flag",{
        opacity:1
    })
})
document.querySelector("#page1-line3").addEventListener("mouseleave",function(){
    gsap.to("#flag",{
        opacity:0
    })
})
